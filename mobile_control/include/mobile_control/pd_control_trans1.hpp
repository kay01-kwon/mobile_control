...
class pd_control{
    ...
    Matrix3d getRotRPYMat(Vector3d rpy);
...
void pd_control::display_base_arm_pose(unsigned int &k)
{
    ...
    base_arm_position_vector.push_back(base_arm_position);
    base_arm_orientation_vector.push_back(base_arm_orientation);
    
    if(base_arm_position_vector.size() > 200)
    {
        base_arm_position_vector.erase(base_arm_position_vector.begin());
        base_arm_orientation_vector.erase(base_arm_orientation_vector.begin());

    }

    base_arm_position_avg = std::accumulate(base_arm_position_vector.begin(),
    base_arm_position_vector.end(),zero_vec);

    base_arm_orientation_avg = std::accumulate(base_arm_orientation_vector.begin(),
    base_arm_orientation_vector.end(),zero_vec);

    base_arm_position_avg = base_arm_position_avg/base_arm_position_vector.size();
    base_arm_orientation_avg = base_arm_orientation_avg/base_arm_orientation_vector.size();
...
Matrix3d pd_control::getRotRPYMat(Vector3d rpy)
{
    Matrix3d Yawmat;
    Matrix3d Pitchmat;
    Matrix3d Rollmat;
    ...
    Yawmat<<cos(rpy(2)), -sin(rpy(2)), 0,
            sin(rpy(2)), cos(rpy(2)), 0,
            0, 0, 1;
    
    Pitchmat<<cos(rpy(1)), 0, sin(rpy(1)),
            0, 1, 0,
